...
public class BaseballCard implements Cloneable{
    ...
    */
     ...
     *@return the year of a BaseballCard as an Integer
     */
    public int getYear(){
      return this.year;
    }
     ...
     *@return the x vector of the size of a BaseballCard as an Integer
     */
     ...
     *@return the y vectorof a BaseballCard as an Integer
     */
     ...
     *@param a the object to be compared with the current BaseballCard
