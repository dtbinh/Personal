...
/**
 * This class serves as the application class for our jClass Designer application.
 * Much of its behavior is inherited from AppTemplate, as defined in the 
 * Simple App Framework. This app starts by loading all the app-specific messages
 * like icon files and tooltips and other settings, then he full User Interface
 * is loaded using those settings. Note that this is a JavaFx Application.
 * 
 * @author Ronald
 * @version 1.0
 */
public class JClassDesigner extends AppTemplate{
    ...
    /**
     * This builder provides methods for properly setting up all the custom 
     * objects needed to run this application. Note that by swapping out these
     * components we could have a very different program that did something
    ...
    /**
     * This is where program execution begins. Since this is a JavaFX app it will
     * simply call launch, which gets JavaFX rolling, resulting in sending the 
     * properly initialized Stage(i.e. window) to the start method inherited 
